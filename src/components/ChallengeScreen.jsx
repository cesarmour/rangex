                ...
                <>
                  <div className="bg-black/40 border border-white/10 rounded-md p-3 space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-1.5 text-[10px]">
                      <QuadrantTag label="Amarelo" desc={analysis.quadrantes?.amarelo} color="yellow" />
                      <QuadrantTag label="Verde" desc={analysis.quadrantes?.verde} color="green" />
                      <QuadrantTag label="Vermelho" desc={analysis.quadrantes?.vermelho} color="red" />
                      <QuadrantTag label="Azul" desc={analysis.quadrantes?.azul} color="blue" />
                    </div>
                  </div>
